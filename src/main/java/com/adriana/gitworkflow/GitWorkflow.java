package com.adriana.gitworkflow;
...
public class GitWorkflow {
    public static void main(String[] args) {
        ...
        String step16 = "If a change is required, then the last commit will be adjusted by using commit amend ";
        String step17 = "In case of a commit amend then a git force should be performed in order to update the remote branch and existing Pull Request ";
        String step18 = "After that, the origin master contains the latest changes and the origin/new_branch_name can be deleted";
        String step19 = "Do not forget that locally ypu are still on the new_branch_name,it's good to move back to master";
